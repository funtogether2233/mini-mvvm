...
function parseText(context) {
    ...
    return { type: 5 /* NodeTypes.TEXT */, content };
}
// 获取并推进内容
...
function parseTag(context, type) {
    ...
    return { type: 1 /* NodeTypes.ELEMENT */, tag };
}
...
function isText(node) {
    return node.type === 2 /* NodeTypes.INTERPOLATION */ || node.type === 5 /* NodeTypes.TEXT */;
}
...
export { createApp, createVNode as createElementVNode, createRenderer, createTextVNode, getCurrentInstance, h, inject, nextTick, provide, proxyRefs, ref, registerRuntimeCompiler, renderSlot, toDisplayString };
